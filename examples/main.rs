...
use urng::rng32::{
    Philox32x4, Philox32x4x4, philox32_new, philox32_next_u32s, philox32x4_new,
    philox32x4_next_u32s, philox32x4x4_new, philox32x4x4_next_u32s,
};
...
// Philox32x4x4 CABI(rayon) : 6.55 GS
// Philox32x4 CABI(rayon)   : 5.41 GS
// Philox32 CABI(rayon)     : 6.42 GS
...
fn main() {
    ...
    benchmark_throughput_32_cabi(N);
}
...
fn benchmark_throughput_32_cabi(n: usize) {
    let mut buffer = vec![0u32; n];
