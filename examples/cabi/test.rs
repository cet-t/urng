...
use urng::{
    ...
    cabi::{
        ...
        pcg32x8_free, pcg32x8_new, pcg32x8_next_u32s, philox32_free, philox32_new,
        philox32_next_u32s, philox32x4x4_free, philox32x4x4_new, philox32x4x4_next_u32s,
        sfc32_free, sfc32_new, sfc32_next_u32s, sfc32x4_free, sfc32x4_new, sfc32x4_next_u32s,
        sfc32x8_free, sfc32x8_new, sfc32x8_next_u32s, sfc32x16_free, sfc32x16_new,
        sfc32x16_next_u32s, sfmt607_free, sfmt607_new, sfmt607_next_u32s, sfmt1279_free,
        sfmt1279_new, sfmt1279_next_u32s, sfmt2281_free, sfmt2281_new, sfmt2281_next_u32s,
        sfmt4253_free, sfmt4253_new, sfmt4253_next_u32s, sfmt11213_free, sfmt11213_new,
        sfmt11213_next_u32s, sfmt19937_free, sfmt19937_new, sfmt19937_next_u32s, sfmt44497_free,
        sfmt44497_new, sfmt44497_next_u32s, sfmt86243_free, sfmt86243_new, sfmt86243_next_u32s,
        sfmt132049_free, sfmt132049_new, sfmt132049_next_u32s, sfmt216091_free, sfmt216091_new,
        sfmt216091_next_u32s, splitmix32_free, splitmix32_new, splitmix32_next_u32s,
        splitmix32x16_free, splitmix32x16_new, splitmix32x16_next_u32s, squares32_free,
        squares32_new, squares32_next_u32s, squares32x8_free, squares32x8_new,
        squares32x8_next_u32s, threefry32x2_free, threefry32x2_new, threefry32x2_next_u32s,
        threefry32x4_free, threefry32x4_new, threefry32x4_next_u32s, xoroshiro64ss_free,
        xoroshiro64ss_new, xoroshiro64ss_next_u32s, xoroshiro64ssx8_free, xoroshiro64ssx8_new,
...
fn main() {
    ...
    let mut r32 = Vec::new();
    bench32!(buf32, r32, philox32x4x4, philox32);
    bench32!(buf32, r32, threefry32x4, threefry32x2);
    bench32!(buf32, r32, squares32, squares32x8);
    bench32!(buf32, r32, pcg32, pcg32x8);
    bench32!(buf32, r32, splitmix32, splitmix32x16);
