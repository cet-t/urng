...
mod tests {
    ...
    fn philox32_works() {
        ...
        assert_eq!(
            rng.nextu(),
            [3153052020, 1439632633, 3707823678, 1301313894]
        );
        assert_eq!(rng.nextf(), [0.0999058, 0.8608589, 0.68340075, 0.88683987]);
    }
    ...
    fn philox32x4x4_works() {
        unsafe {
            ...
            assert_eq!(
                rng.nextu(),
                [
                    1630719031, 2925807103, 1670284822, 3314328339, 3813252649, 4214557236,
                    1732908927, 1130405880, 2854163582, 2724611973, 961091223, 3131816962,
                    4147983695, 4073149878, 2281172732, 4120634246
                ]
            );
            assert_eq!(
                rng.nextf(),
