...
use crate::prng::b64::{SplitMix64, Xoshiro256Pp, Xoshiro256Ss};
use crate::rng::Rng;
...
#[cfg(feature = "simd")]
mod simd {
    use crate::prng::b64::{SplitMix64, Xoshiro256Ssx2};
    use crate::rng::Rng;
    use rayon::prelude::*;
    use std::arch::x86_64::*;
    use std::slice::from_raw_parts_mut;
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn xoshiro256ssx2_next_u64s(
        ptr: *mut Xoshiro256Ssx2,
        out: *mut u64,
        count: usize,
    ) {
        if count == 0 {
